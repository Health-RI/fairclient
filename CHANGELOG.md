...
### Changed
- doc: update CHANGELOG.md for v1.0.3 by @Health-RI Admin in b535a22
...
### Fixed
- fix: drops pypy support by @Alexander Harms in 561ab96
- fix: fixes test matrix in github actions by @Alexander Harms in 4bfc993
- fix: fixes types, remove support for Python <3.11 by @Alexander Harms in 48014cb
- fix: fixes formatting issues by @Alexander Harms in 37614e7
